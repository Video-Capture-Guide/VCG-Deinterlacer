...
echo.
echo ============================================================
echo  VCG Deinterlacer Beta-02 - Build Script
echo ============================================================
echo.
...
set SOURCE=vcg_deinterlacer_beta_0_5.py
if not exist "%SOURCE%" (
...
if not exist "dist\VCG_Deinterlacer.exe" (
    echo.
    echo ============================================================
    echo  BUILD FAILED  ^(dist\VCG_Deinterlacer.exe not produced^)
    echo ============================================================
    echo.
    echo Common causes:
...
echo ============================================================
echo.
echo Output:  dist\VCG_Deinterlacer.exe
echo.
...
echo.
echo Next steps:
echo   1. Test the EXE:  dist\VCG_Deinterlacer.exe
echo   2. Package as ZIP (Beta-02 portable -- no installer needed):
echo      - Create a folder:  VCG_Deinterlacer_Beta-02\
echo      - Copy into it:     dist\VCG_Deinterlacer.exe
echo      -                   logo.png
echo      -                   README.txt  (rename from README.md)
echo      -                   LICENSE.txt
echo      - Zip the folder:   VCG_Deinterlacer_Beta-02.zip
